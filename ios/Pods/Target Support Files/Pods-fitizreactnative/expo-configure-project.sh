...
with_node --no-warnings --eval "require('expo-modules-autolinking')(process.argv.slice(1))" generate-package-list  --target "/Users/gefo/gefo/uni/WiSe23_24/lssad-practikum/project/fitiz-UI/ios/Pods/Target Support Files/Pods-fitizreactnative/ExpoModulesProvider.swift"
