...
const AppBottomTabs = observer(() => {
    return (
            <Tab.Navigator screenOptions={{
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Ionicons name={focused ? "home" : "home-outline"} color={focused ? "#57E78DFF" : undefined} size={25}/>
                    ),
                    headerShown: false,
                }}/>
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Ionicons name={focused ? "trophy" : "trophy-outline"} color={focused ? "#57E78DFF" : undefined} size={25}/>
                    ),
                    headerShown: false,
                }}/>
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Ionicons name={focused ? "map" : "map-outline"} color={focused ? "#57E78DFF" : undefined} size={25}/>
                    ),
                    headerShown: false,
                }}/>
                ...
                options={{
                    tabBarIcon : ({ focused }) => (
                        <Ionicons name={focused ? "person" : "person-outline"} color={focused ? "#57E78DFF" : undefined} size={25}/>
                    ), 
                    headerShown: false,
                }}/>
            </Tab.Navigator>
